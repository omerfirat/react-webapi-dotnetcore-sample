...
export default function XFastSmsList() {
    ...
    const handleSubmit = (event) => {
        ...
        setLoading(true);
        fetch('api/request/fast_list/list_all', requestOptions)
            .then(function (response) {
                return response.json();
            })
            .then(function (result) {
    ...
    if (getLogin())
    {
        return (
            <div>
                ...
                <p>This component demonstrates fetching data from the fast sms</p>
